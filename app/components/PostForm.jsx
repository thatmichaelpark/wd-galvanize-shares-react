...
const PostForm = React.createClass({
  ...
  handleChange(event) {
    const nextPost = Object.assign({}, this.state.post, { [event.target.name]: event.target.value });
  ...
  handleTouchTapSave() {
    ...
    result.value.votes = 1;
    this.props.updatePost(this.props.post, result.value);
  },
  render() {
